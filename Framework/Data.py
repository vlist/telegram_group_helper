...
class Data:
    def __init__(self, name:str) -> None:
        ...
        Question: Are we going to use MultiProcessing on different machiens? If so, we may need
                  serialization & deseriaziation methods.

        Args:
            name (str): name of the data. This must be unique with in the same module.
        """
        self.name = name # Name of the data. It must be unique in the same moduel.
        ...
        self.feed_back = False # If this is a feedbackable data. If true, inital_value must be provided.
        self.ready = False # If this data ready to use. It must be true to be considerted as OK to pass to the module that requires this. 
