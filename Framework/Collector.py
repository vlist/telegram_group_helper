...
class Collector:
    def __init__(self) -> None:
        ...
        self._inited = False # If this module is initlized.
    ...
    def addOut(self, *data: Data):
        ...
        for this_data in data:
            if this_data.name in self.data_out:
                raise FE.MultipleInstancesException("\"{:s}\" already exists in the data_out for this module.".format(this_data.name))
    ...
    def addIn(self, *data: Data):
        ...
        for this_data in data:
            if this_data.name in self.data_in:
                raise FE.MultipleInstancesException("\"{:s}\" already exists in the data_in for this module.".format(this_data.name))
